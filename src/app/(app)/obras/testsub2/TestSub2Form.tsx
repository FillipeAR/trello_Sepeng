...
export function TestSub2Form() {
  ...
  return (
    <form action={formAction} className="card space-y-5 p-6">
      ...
      <input name="name" required defaultValue="x" className="input" />

      <span className="label">Cliente</span>
      <input name="client" required defaultValue="x" className="input" />
      ...
      <input name="location" required defaultValue="x" className="input" />
      ...
      <textarea name="scopeSummary" rows={4} required defaultValue="x" className="input" />
